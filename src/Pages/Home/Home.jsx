        ...
        <MyContainer>
          ...
          <div className="">
            ...
            <div className="sm:flex space-y-4 text-center justify-center gap-7 py-6">
              <div className="bg-linear-to-br from-green-400 to-green-800 p-6 rounded-2xl text-"><div className="flex justify-center"><FaBookOpenReader size={30}/></div>Read book</div>
              <div className="bg-linear-to-br from-orange-400 to-orange-700 p-6 rounded-2xl text-"><div className="flex justify-center"><BiSolidBookAdd size={30}/></div>Add book</div>
              <div className="bg-linear-to-br from-yellow-300 to-yellow-600 p-6 rounded-2xl text-"><div className="flex justify-center"><TiEdit size={30} /></div>Edit book</div>
              <div className="bg-linear-to-br from-red-500 to-red-800 p-6 rounded-2xl text-"><div className="flex justify-center"><MdAutoDelete size={30} /></div>Delete book</div>
            </div>
          </div>
